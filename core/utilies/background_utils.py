...
def save_background_path(path: str):
    ...
    try:
        ...
        config_path_abs = resource_path(config_path)
        ...
        if path:
            ...
            # إزالة إعداد التدرج إذا كان موجوداً
            if "background_gradient" in config:
                del config["background_gradient"]
        elif "background_image" in config:
            del config["background_image"]
...
def save_background_gradient(gradient_index: int):
    ...
    try:
        ...
        # تحديث الإعدادات
        config["background_gradient"] = gradient_index
        
        # إزالة إعداد الصورة إذا كان موجوداً
